...
public class TypeCheckTest {
	 ...
	 */
	 ...
	 public void testDec2() throws Exception {
		 String input = "prog boolean helloworld;";
		 typeCheck(input);
	 }
	 
	 @Test
	 public void testDec3() throws Exception {
		 String input = "prog int mango = sin(a);\nint apple =  (a+x == X) ? a : x ;";
		 typeCheck(input);
	 }

	 @Test
	 public void testDec4() throws Exception {
		 String input = "prog int apple =  (a+b == true) ? c : e ;";
		 thrown.expect(SemanticException.class);
		 typeCheck(input);
	 }
	 ...
	 public void testDec5() throws Exception {
		 String input = "prog image name <- newImage;";
		 thrown.expect(SemanticException.class);
		 typeCheck(input);
	 }
	 ...
	 public void testDec6() throws Exception {
		 String input = "prog file newImage = \"newimagefile\";image name <- newImage;";
		 typeCheck(input);
	 }
	 
	 
	 @Test
     public void testSmallestCheck() throws Exception {
